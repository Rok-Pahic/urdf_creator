...
for link in robot_links:
    ...
    urdf_link = Link(name = segment_hierarchy[-1], visual = None, inertial = None, collision = None, origin = link_pose)

    robot.add_link(urdf_link)

file_handle = open("robot_test.xml","w")
print(robot)
